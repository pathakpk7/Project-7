...
import { Sparkles, Trophy, Heart, Flame, Award, Zap, X } from "lucide-react";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-300">
      <div className="relative w-full max-w-lg rounded-3xl bg-surface-raised border border-csk-gold/40 p-6 sm:p-8 text-center shadow-glow-gold overflow-hidden">
        ...
        <h3 className="text-2xl font-extrabold uppercase tracking-tight text-white mb-2">
          THE MYSTIQUE OF NO. 7
        </h3>
        <p className="text-xs text-csk-gold font-mono uppercase tracking-widest mb-4">
          Born 7th July • Jersey #7 • 7 ICC / IPL Finals Won
        </p>
        ...
        <p className="text-sm text-slate-300 leading-relaxed mb-6">
          ...
          <br />
          <span className="text-xs text-slate-400 mt-1 block italic">— MS Dhoni</span>
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 justify-center">
          <button
            ...
            className="w-full sm:w-auto px-6 py-3 rounded-xl bg-gradient-to-r from-csk-gold to-csk-yellow text-black font-mono font-bold text-sm uppercase tracking-wider hover:scale-105 active:scale-95 transition-all shadow-glow-gold flex items-center justify-center gap-2"
          >
          ...
          <button
            onClick={onClose}
            className="w-full sm:w-auto px-6 py-3 rounded-xl bg-white/10 hover:bg-white/20 text-white font-mono text-sm uppercase tracking-wider transition-colors"
          >
            CLOSE
          </button>
        </div>
