...
export const DhoniVsEraSection: React.FC = () => {
  ...
  return (
    <section id="era" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative">
      ...
      <div className="rounded-2xl bg-surface/90 border border-white/10 p-4 sm:p-6 backdrop-blur-xl shadow-xl mb-6 relative overflow-hidden">
        
        {/* Headings */}
        <div className="grid grid-cols-2 gap-3 pb-4 border-b border-white/10 text-center font-mono">
          <div className="p-3 rounded-xl bg-csk-gold/10 border border-csk-gold/30">
            <span className="text-[10px] text-csk-yellow uppercase tracking-widest font-bold block mb-0.5">REFERENCE SUBJECT</span>
            <h3 className="text-base sm:text-xl font-extrabold text-white">MS DHONI</h3>
            <p className="text-[10px] text-slate-400 mt-0.5">{dhoni.role}</p>
          </div>

          <div className="p-3 rounded-xl bg-white/5 border border-white/10">
            <span className="text-[10px] text-slate-400 uppercase tracking-widest font-bold block mb-0.5">COMPARISON PEER</span>
            <h3 className="text-base sm:text-xl font-extrabold text-white">{peer.player}</h3>
            <p className="text-[10px] text-slate-400 mt-0.5">{peer.role}</p>
          </div>
        </div>
        ...
        <div className="space-y-2 pt-4 font-mono text-xs">
          ...
          {/* ODI Average */}
          <div className="p-2.5 sm:p-3 rounded-xl bg-surface-raised border border-white/5 flex items-center justify-between">
            <div className="text-left font-bold text-csk-yellow w-1/3">{dhoni.odis_avg}</div>
            <div className="text-center text-[11px] text-slate-400 uppercase w-1/3">ODI Batting Average</div>
          ...
          <div className="p-2.5 sm:p-3 rounded-xl bg-surface-raised border border-white/5 flex items-center justify-between">
            ...
            <div className="text-center text-[11px] text-slate-400 uppercase w-1/3">ODI Runs</div>
          ...
          <div className="p-2.5 sm:p-3 rounded-xl bg-surface-raised border border-white/5 flex items-center justify-between">
            ...
            <div className="text-center text-[11px] text-slate-400 uppercase w-1/3">ODI Strike Rate</div>
          ...
          <div className="p-2.5 sm:p-3 rounded-xl bg-surface-raised border border-white/5 flex items-center justify-between">
            ...
            <div className="text-center text-[11px] text-slate-400 uppercase w-1/3">IPL Runs (Avg)</div>
          ...
          <div className="p-2.5 sm:p-3 rounded-xl bg-surface-raised border border-white/5 flex items-center justify-between">
            ...
            <div className="text-center text-[11px] text-slate-400 uppercase w-1/3">Test Runs (Avg)</div>
          ...
          <div className="p-2.5 sm:p-3 rounded-xl bg-surface-raised border border-white/5 flex items-center justify-between">
            ...
            <div className="text-center text-[11px] text-slate-400 uppercase w-1/3">Wicketkeeping</div>
          ...
          <div className="p-2.5 sm:p-3 rounded-xl bg-surface-raised border border-white/5 flex items-center justify-between">
            ...
            <div className="text-center text-[11px] text-slate-400 uppercase w-1/3">Titles as Captain</div>
          ...
          <div className="p-2.5 sm:p-3 rounded-xl bg-surface-raised border border-white/5 flex items-center justify-between">
            ...
            <div className="text-center text-[11px] text-slate-400 uppercase w-1/3">ODI Career Not Outs</div>
